...
export class Fluid {
  ...
  applyBackground(type, value, options = null, canvas = this.canvas) {
    ...
    function gradient() {
      ...
      switch (options) {
        case 'radial':
          gradientValue = 'radial-gradient(' + value + ')';
          break;
        case 'conic':
          gradientValue = 'conic-gradient(' + value + ')';
          break;
        case 'repeating-linear':
          gradientValue = 'repeating-linear-gradient(' + value + ')';
          break;
        case 'repeating-radial':
          gradientValue = 'repeating-radial-gradient(' + value + ')';
          break;
        case 'linear':
        default:
          gradientValue = 'linear-gradient(' + value + ')';
      }

      /* Set Gradient Dom Style */
      canvas.style.backgroundImage = gradientValue;
    }
