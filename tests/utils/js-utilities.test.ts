...
describe('js-utilities :: getExpTime', () => {
  ...
  it('should return 15 minutes in the future related to sent time if time sent', () => {
    ...
    expect(getExpireTime(15, date)).toEqual(date + 15 * 60 * 1000);
  });

  it('should convert string to date if string sent to be the final expire time', () => {
    expect(getExpireTime(0, '2024-10-23T09:50:50.734+00:00')).toEqual(1729677050734);
  });
});
